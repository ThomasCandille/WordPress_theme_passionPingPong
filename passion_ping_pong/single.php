...
?>
	...
	<main id="primary" class="site-main">
		...
		while ( have_posts() ) :
			...
			the_post_navigation(
				array(
					'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'passion_ping_pong' ) . '</span> <span class="nav-title">%title</span>',
					'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'passion_ping_pong' ) . '</span> <span class="nav-title">%title</span>',
				)
			);
